...
export default async function SuperAdminAyudaPage() {
    ...
    <div className="space-y-6 p-4 md:p-8">
      <div>
        ...
        <p className="page-subtitle mt-1">
          Manual paso a paso del panel de plataforma y soporte directo por WhatsApp.
        </p>
      </div>

      <div className="flex flex-col gap-4 md:flex-row">
        <a
          href="/manual-super-admin.pdf"
          target="_blank"
        ...
        >
          ...
          <span>
            ...
            <span className="block text-xs text-gray-500">Manual del Super Admin en PDF</span>
          </span>
        </a>
