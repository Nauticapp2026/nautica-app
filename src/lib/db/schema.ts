...
export const profiles = pgTable('profiles', {
  ...
  telefono: text('telefono'),
  // Dirección personal desglosada (mig 0143): `direccion` es SOLO la calle.
  direccion: text('direccion'),
  direccionNumero: text('direccion_numero'),
  ciudad: text('ciudad'),
  provincia: text('provincia'),
  codigoPostal: text('codigo_postal'),
  contactoEmergencia: text('contacto_emergencia'),
  cuit: text('cuit'),
  // Dirección fiscal desglosada (mig 0143): `direccionFiscal` es SOLO la calle.
  direccionFiscal: text('direccion_fiscal'),
  direccionFiscalNumero: text('direccion_fiscal_numero'),
  ciudadFiscal: text('ciudad_fiscal'),
  provinciaFiscal: text('provincia_fiscal'),
  condicionIibb: condicionIibbEnum('condicion_iibb'),
