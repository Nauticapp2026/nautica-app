...
3. La navegación lateral muestra las secciones, en este orden: Inicio, Guarderías, Usuarios, **Salidas**, Comunicaciones, Publicidades, Notificaciones, Moderación, Pricing y Términos.
...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Socios **y sus cuentas**, embarcaciones, toda la estructura de espacios (áreas, marinas, naves, pisos, espacios), tarifario, servicios contratados, cuenta corriente, comprobantes, cobranzas, débitos Payway y tarjetas, tareas, salidas, lavados, invitados y accesos, solicitudes, comunicaciones, mails masivos y publicaciones (con sus archivos). **También el punto de venta, los centros emisores y las credenciales de TusFacturas.** | El club y su configuración: razón social, CUIT y condición IVA, plan e historial de plan, horarios, credenciales Payway, fotos, período de anulación. El **equipo** completo (admins, operarios, seguridad) y sus invitaciones pendientes. |

**La numeración vuelve a 1**: el próximo recibo es RC-000001 / RI-000001, el próximo comprobante interno CI-000001, y el próximo socio es el #1.

**Después del reset, el club tiene que volver a configurar Datos Impositivos** (punto de venta y certificado). Es a propósito: las credenciales de TusFacturas que un club tiene guardadas son las que le devolvió la **cuenta madre** al dar de alta su punto de venta. Si la madre cambió (por ejemplo, pasó a la cuenta de prueba), un club que conservara las viejas seguiría facturando contra la cuenta anterior. Al soltarlas, el alta nueva sale contra la madre vigente.
